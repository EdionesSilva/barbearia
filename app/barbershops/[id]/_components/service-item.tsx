    ...
    const timeList = useMemo(() => {
        ...
        return generateDayTimeList(date).filter(time =>{
            ...
            const booking = dayBookings.find(booking => {
                ...
                const bookinMinutes = booking.date.getMinutes();

                return bookingHour === timeHour && bookinMinutes === timeMinutes;
            });
                        ...
                        <div className="flex items-center justify-between mt-3">
                            ...
                            <Sheet open={sheetIsOpen} onOpenChange={setSheetIsOpen}>
                                ...
                                <SheetContent className="p-0">
                                    ...
                                    {date && (
                                        <div className="flex gap-3 overflow-auto [&::-webkit-scrollbar]:hidden py-6 px-5 border-t border-solid border-secundary">
                                            {timeList.map((time) => (
