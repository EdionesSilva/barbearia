            ...
            <SheetContent className="px-0">
                ...
                <div className="px-5">
                    ...
                    <SheetFooter className="flex-row gap-3 mt-6">
                        ...
                        <Button onClick={handleCancelClick} disabled={!isBookingConfirmed || isDeleteLoading} className="w-full" variant="destructive"> {isDeleteLoading && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}Cancelar Reserva</Button>
                    </SheetFooter>
                </div>
            </SheetContent>
        </Sheet>
